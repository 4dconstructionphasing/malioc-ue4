...
private:
    ...
    FMaliOCStyle() = default;
    ~FMaliOCStyle() = default;
    FMaliOCStyle(const FMaliOCStyle&) = delete;
    FMaliOCStyle(FMaliOCStyle&&) = delete;
    FMaliOCStyle& operator=(const FMaliOCStyle&) = delete;
    FMaliOCStyle& operator=(FMaliOCStyle&&) = delete;
};
