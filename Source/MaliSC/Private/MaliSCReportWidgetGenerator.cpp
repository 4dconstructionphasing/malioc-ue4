...
#include "MaliSCReportWidgetGenerator.h"
        ...
        [
            ...
            + SVerticalBox::Slot()
                ...
                [
                    ...
                    .TextStyle(FMaliSCStyle::Get(), "Text.Normal")
    ...
    for (const auto& string : StringArray)
    {
        verticalBox->AddSlot()
            ...
            [
                ...
                .TextStyle(FMaliSCStyle::Get(), "Text.Normal")
                .DecoratorStyleSet(FMaliSCStyle::Get().Get())
                .AutoWrapText(true)
            ];
    }
...
TSharedRef<SWidget> ConstructErrorWidget(const TArray<TSharedRef<FMaliSCReport::FErrorReport>>& Errors)
{
...
TSharedRef<SVerticalBox> GenerateMidgardStatsTable(const TSharedRef<FMaliSCReport::FMidgardReport::FRenderTarget>& RenderTarget)
{
...
TSharedRef<SWidget> ConstructMidgardDumpWidget(const TArray<TSharedRef<FMaliSCReport::FMidgardReport>>& Reports, bool DumpSourceCode)
{
...
TSharedRef<SWidget> ConstructUtgardDumpWidget(const TArray<TSharedRef<FMaliSCReport::FUtgardReport>>& Reports, bool DumpSourceCode)
{
...
TSharedPtr<SWidget> ConstructReportWidget(const FAsyncReportGenerator& Generator)
{
    ...
    if (Report->MidgardReports.Num() > 0)
    {
        ...
        TMap<FString, TArray<TSharedRef<FMaliSCReport::FMidgardReport>>> VertexFactoryNames;
    ...
    if (Report->UtgardReports.Num() > 0)
    {
        ...
        // Dump the rest of the shaders by vertex factory name
        TMap<FString, TArray<TSharedRef<FMaliSCReport::FUtgardReport>>> VertexFactoryNames;
...
TSharedRef<SWidget> FReportWidgetGenerator::GetWidget()
{
    ...
    else
    {
        ...
        {
            check(progress == FAsyncReportGenerator::EProgress::OSC_COMPILATION_IN_PROGRESS);

            const auto oscProgress = Generator->GetOSCCompilationProgress();
