...
public:
    ...
    /** @return the path to the MaliSC folder (assuming it has been installed in the correct place) */
    static const FString& GetMaliSCFolderPath();

    /** @return the path to the OfflineCompiler folder inside the MaliSC folder */
