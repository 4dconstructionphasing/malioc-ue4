    ...
    void InitializeWidgets()
    {
                ...
                [
                    ...
                    [
                        ...
                        [
                            ...
                            .Font(FMaliSCStyle::GetNormalFontStyle())
                        ]
                        + SHorizontalBox::Slot()
                            .FillWidth(1.0f)
                            .MaxWidth(200.0f)
        ...
        + SVerticalBox::Slot()
            ...
            [
                ...
                [
                    SNew(STextBlock)
                    .Text(LOCTEXT("MaliSCHelpString", "Click \"Compile\" to see the estimated shader performance statistics for the current material."))
                    .AutoWrapText(true)
...
private:
    ...
    void InitializeWidgets()
    {
        const auto OpenMaliSCFolder = [&]() -> void
        {
            FPlatformProcess::ExploreFolder(*FCompilerManager::GetMaliSCFolderPath());
        };
